    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item text-center"><a class="nav-link active" href="#">Nos Pains</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Nos Viennoiseries</a></li>
                <li class="nav-item"><a class="nav-link" href="#">Nos Patisseries</a></li>
            </ul>
